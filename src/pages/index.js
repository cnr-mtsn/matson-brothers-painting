...
export default function Home() {
	...
	return (
		<div className="flex flex-col justify-center p-4 md:p-8 w-full md:w-[90%] mx-auto">
			<div className="flex flex-col lg:flex-row items-center justify-center gap-8 bg-stone-800 bg-opacity-20 dark:bg-opacity-0 py-6 lg:mt-16">
			...
			<div className="flex flex-col justify-center gap-6 mt-20">
				<h2 className="w-full border-b-2 border-black dark:border-stone-500 text-3xl text-black dark:text-stone-200 pb-4">
					Some of our work
				</h2>
